 ...
 * hbase 工具类
 */
public class HBaseUtilsTTO {

    private static final Logger logger = LoggerFactory.getLogger(HBaseUtilsTTO.class);
...
//         System.out.println("---------- " + conn.hashCode());
    ...
    public static void incrementColumnValue(String tableName,
                                            String rowkey, String cf, String qualifier, long value ) throws IOException {
        Connection conn = getConnection();
